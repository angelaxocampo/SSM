...
Your R code should start with ````{r}` and should end with ```` 
...
Because there are so many variables, we will have to work with the codebook to identify key and relevant variables for our research. This is of course after have 
